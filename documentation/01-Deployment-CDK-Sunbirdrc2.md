...
| ROLE_ARN                   | arn:aws:iam::123456789012:role/AWSReservedSSO_AWSAdministratorAccess        | Amazon EKS master's role to be associated with the system:masters RBAC group, giving super-user access to the cluster                                                    |
